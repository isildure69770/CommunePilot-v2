...
export default function SignalementsPage() {
  ...
  function handleCreateMission(event: React.FormEvent) {
    ...
    const mission: Mission = {
      ...
      priority: missionForm.priority, status: "À faire", dueDate: missionForm.dueDate, category: missionSignalement.category,
    ...
    notify({ userIds: missionForm.assigneeIds, title: "Nouvelle mission agent", message: mission.title, link: "/terrain" });
