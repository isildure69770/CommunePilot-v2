...
export const permissionMatrix: Record<UserRole, Record<PermissionDomain, DomainPermissions>> = {
  ...
  Adjoint: { dashboard: read(), mails: edit(), dossiers: edit(), documents: edit(), equipements: edit(), missions: edit(), signalements: edit(), carte: edit(), calendrier: edit(), utilisateurs: edit() },
