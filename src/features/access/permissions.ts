...
export const permissionMatrix: Record<UserRole, Record<PermissionDomain, DomainPermissions>> = {
  ...
  "Agent administratif": { dashboard: read(), mails: edit(), dossiers: edit(), documents: edit(), equipements: read(), missions: edit(), signalements: edit(), carte: read(), calendrier: edit(), utilisateurs: none() },
  "Agent technique": { dashboard: none(), mails: none(), dossiers: none(), documents: none(), equipements: read(), missions: { view: true, create: false, update: true, delete: false }, signalements: { view: true, create: true, update: false, delete: false }, carte: read(), calendrier: none(), utilisateurs: none() },
};
