...
export type AlertStatus = "Nouveau" | "Pris en compte" | "Traitée" | "Transformé en mission" | "Classé" | "Supprimée";
export interface FieldAlert { id: string; category: "Voirie" | "Bâtiment" | "Espaces verts" | "Eau" | "Sécurité" | "Autre"; priority: MissionPriority; comment: string; address: string; latitude?: number; longitude?: number; photos: FileAttachment[]; status: AlertStatus; createdBy: string; createdAt: string; updatedAt: string; handledBy?: string; handledAt?: string; completedAt?: string; deletedAt?: string; deletedBy?: string; missionId?: string; dossierId?: number; }
