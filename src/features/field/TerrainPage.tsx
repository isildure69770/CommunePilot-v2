...
export default function TerrainPage() {
  ...
  const deleteAlert = (alert: FieldAlert) => {
    ...
    if (!window.confirm("Supprimer cette fiche ? Elle restera visible dans l’historique avec la mention « Supprimée ».")) return;
    const now = new Date().toISOString();
